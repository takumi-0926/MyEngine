...
bool GameManager::Initalize(Wrapper* dx12, Audio* audio, Input* input)
{
	...
	if (!Sprite::loadTexture(6, L"Resources/clear.png")) {
		assert(0);
		return false;
	}
	...
	enemy = PMDobject::Create(modelPlayer);
